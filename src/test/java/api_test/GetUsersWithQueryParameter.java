...
public class GetUsersWithQueryParameter {
    private static final Logger LOGGER = LogManager.getLogger(GetUsersWithQueryParameter.class);

    @Test
    public void getUsersWithQueryParameter() {
        LOGGER.info("---------API Test: Get All User With Query Parameter----------");
